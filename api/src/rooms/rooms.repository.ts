...
import { RoomMemberRow, RoomRow } from '../database/types';
import { toRoomMemberRow } from '../database/prisma-mappers';
...
export class RoomsRepository {
  ...
  async findByRoomName(roomName: string): Promise<RoomRow | null> {
